...
3. Clone this project.
     ```t
        git clone https://github.com/supzi-del/blood-donation-managemen.git
     
4. Extract files in C:\xampp\htdocs.

5. Open link localhost/phpmyadmin

6. Create a new database and give the name as bbdms and click on create button.

7. Import the sql file located in the directory bloodbank/sqlfile/bbdms.sql

8. Open any browser and type http://localhost/bloodbank/bbdms/index.php to open the User panel.
